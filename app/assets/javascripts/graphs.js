...
$(function () {
    var myScatterGraph = Highcharts.chart('scatter_graph-container', {
        chart: {
            type: 'scatter',
            zoomType: 'xy'
        },
        title: {
            text: 'Rating Comparisions Between Yahoo Sports Ratings vs. JockBuff Ratings for 2015 NHL Stats'
        },
        subtitle: {
            text: 'Source: Yahoo Fantasy Sports'
        },
...
$(function () {
    var myBubbleChart = Highcharts.chart('bubble_graph-container', {
...
$(function () {
    // Set up the chart
    var myColumnChart = Highcharts.chart('column_graph-container', {
        chart: {
            renderTo: 'container',
            type: 'column',
            options3d: {
